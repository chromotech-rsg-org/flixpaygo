  ...
  const tenants: Tenant[] = [
    {
      ...
      theme: {
        ...
        editorialSections: [
          ...
          { type: 'experience', heading: 'A Darkflix não é um streaming tradicional.', body: 'É um espaço onde filmes fora do circuito comercial voltam a circular — obras atmosféricas, cultuadas e difíceis de encontrar. Filmes que não foram feitos para agradar. Foram feitos para permanecer.', image: '/darkflix/content-block.png' },
    ...
    },
    {
      ...
      streamingApi: { baseUrl: 'https://sms.yplay.com.br/', authType: 'youcast', login: 'cinemaflix.api', secret: 'cinema_secret_placeholder', credential: '', endpoints: { createUser: { method: 'POST', path: 'api/integration/createMotvCustomer' }, authenticateUser: { method: 'POST', path: 'api/devices/motv/apiLoginV2' }, findUser: { method: 'POST', path: 'api/customer/getDataV2' }, searchUser: { method: 'POST', path: 'api/customer/findCustomerForSales' }, updateUser: { method: 'POST', path: 'api/integration/updateMotvCustomer' }, enablePlan: { method: 'POST', path: 'api/integration/subscribe' }, disablePlan: { method: 'POST', path: 'api/integration/cancel' }, checkStatus: { method: 'POST', path: 'api/subscription/getCustomerSubscriptionInfo' }, listPlans: { method: 'POST', path: 'api/sales/getAllowedProductsForCustomer' } } },
    ...
    },
    {
      ...
      streamingApi: { baseUrl: 'https://sms.yplay.com.br/', authType: 'youcast', login: 'seriesplay.api', secret: 'series_secret_placeholder', credential: '', endpoints: { createUser: { method: 'POST', path: 'api/integration/createMotvCustomer' }, authenticateUser: { method: 'POST', path: 'api/devices/motv/apiLoginV2' }, findUser: { method: 'POST', path: 'api/customer/getDataV2' }, searchUser: { method: 'POST', path: 'api/customer/findCustomerForSales' }, updateUser: { method: 'POST', path: 'api/integration/updateMotvCustomer' }, enablePlan: { method: 'POST', path: 'api/integration/subscribe' }, disablePlan: { method: 'POST', path: 'api/integration/cancel' }, checkStatus: { method: 'POST', path: 'api/subscription/getCustomerSubscriptionInfo' }, listPlans: { method: 'POST', path: 'api/sales/getAllowedProductsForCustomer' } } },
