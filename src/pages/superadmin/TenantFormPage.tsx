        ...
        <TabsContent value="visual" className="glass-card p-6 space-y-6">
          ...
          <div>
            ...
            {tenant.theme.section4BgImage && (
              <div className="relative inline-block mt-2">
                <img src={tenant.theme.section4BgImage} alt="Seção 4" className="h-32 rounded-lg object-cover" />
                <button type="button" onClick={() => update('theme.section4BgImage', '')} className="absolute -top-2 -right-2 h-5 w-5 rounded-full bg-destructive text-white flex items-center justify-center hover:bg-destructive/80"><X size={12} /></button>
              </div>
            )}
          </div>
        </TabsContent>
